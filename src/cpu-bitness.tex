...
\toprule
Intel 8008 & \cite{intelchips} 1972 & \cite[p.3]{intel8008} 8-22 bits & \cite[p.3]{intel8008} 8 bits & \cite[p.1]{intel8008} 14 bits & \cite[p.2]{intel8008} 8 bits & MCS-8, Mark-8 &  \\
\hline
Intel 8080 & \cite{intelchips} 1974 & 8-24 bits & 8/16 bits & 16 bits & 8 bits & Altair 8800 &  \\
\hline
Intel 8088 & 1978 & 8-48 bits & 8/16 bits & 16/20 bits & 20 bits & IBM PC & data is fetched 8 bits at a time from memory, but internally is stored in 16 bit registers \\
\hline
Intel 8086 & \cite{intelchips} 1978 & 8-48 bits & 16 bits & 16/20 bits & 20 bits & IBM PS/2 & access to addresses beyond 16 bits requires banking of segments \\
\hline
